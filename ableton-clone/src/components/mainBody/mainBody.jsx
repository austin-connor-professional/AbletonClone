...
const MainBody = () => {
    return (
        <div className="main-body-container">
            ...
            <div className="body-text regular-text">
                <h3 className="regular-text">We believe it takes focus to create truly oustanding instruments. We only work on a few products and we strive to make them great.</h3>
            </div>
        </div>
    );
}
